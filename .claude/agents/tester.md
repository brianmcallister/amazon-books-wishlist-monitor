...
Commit any fixes with substantive messages. When the suite is green (or you've documented why it can't be, with specifics) and you've reported your live-check determination, hand off — the pipeline either proceeds to the approval-gated live-check job (if warranted) or straight to the PR Risk Analyzer, not you.
