...
You are given a GitHub issue (read it directly via `gh issue view`, or its text pasted into your prompt) and a branch/worktree already checked out. Your job, in order:
